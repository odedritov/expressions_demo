import {
  ...
  __toESM,
  require_auto_bind
} from "./chunk-TMIX5PWW.js";

// node_modules/@jspsych/plugin-audio-keyboard-response/dist/index.js
...
var _AudioKeyboardResponsePlugin = class _AudioKeyboardResponsePlugin {
  constructor(jsPsych) {
  ...
  trial(display_element, trial, on_load) {
    return new Promise(async (resolve) => {
      ...
      this.startTime = (_a = this.jsPsych.pluginAPI.audioContext()) == null ? void 0 : _a.currentTime;
...
_AudioKeyboardResponsePlugin.info = info;
var AudioKeyboardResponsePlugin = _AudioKeyboardResponsePlugin;
export {
  AudioKeyboardResponsePlugin as default
};
//# sourceMappingURL=@jspsych_plugin-audio-keyboard-response.js.map
